...
#define to_set(psi)             &psi->ssm.assist.reminder.drinking.drink.distance
...
static void _pickerCheckEvent(picker_screen_info *psi)
{
    ...
    /* 保存设置 */
    set->onOff = true;
    psi->ssm.assist.reminder.drinking.choice = 1;
...
const picker_ops picker_ops_reminder_drink_distance = {
