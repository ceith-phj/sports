...
#define ARG_PICKER_1            0, 55,5                                     /**< 第1列选择器. */
#define to_set(psi)             &psi->ssm.assist.virtualPacer
...
static void _settingCreate(picker_screen_info *psi)
{
    ...
    psi->picker = createPicker(psi->sc, &pdata, PICKER_DOUBLE, _ST(TK_VP_PACER), NULL);
...
const picker_ops picker_ops_virtual_pacer = {
