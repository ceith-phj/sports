...
#define to_set(psi)             &psi->ssm.assist.reminder.energy.energy.distance
...
static void _pickerCheckEvent(picker_screen_info *psi)
{
    ...
    /* 保存设置 */
    set->onOff = true;
    psi->ssm.assist.reminder.energy.choice = 1;
...
const picker_ops picker_ops_reminder_energy_distance = {
